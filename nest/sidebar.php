...
<section id="secondary" role="complementary" class="sidebar">
	...
	<aside id="recent-posts-2" class="widget-container widget_recent_entries">
		<h3 class="widget-title"><?php _e( 'Recent Posts', 'nest' ); ?></h3>
		<ul>
			<?php
	...
	<aside id="categories-2" class="widget-container widget_categories">
		<h3 class="widget-title"><?php _e( 'Categories', 'nest' ); ?></h3>
		<ul>
	...
	<aside id="tag_cloud-2" class="widget-container widget_tag_cloud">
		<h3 class="widget-title"><?php _e( 'Tag Cloud', 'nest' ); ?></h3>
		<ul>
			<?php wp_tag_cloud(); ?>
		</ul>
	</aside>
	...
	<aside id="archives-2" class="widget-container widget_archive">
		<h3 class="widget-title"><?php _e( 'Archives', 'nest' ); ?></h3>
		<ul>
			<?php wp_get_archives(); ?>
		</ul>
	</aside>
